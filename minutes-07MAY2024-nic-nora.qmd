...
Current residential sites scheduled:
- Tia's house (Thursday)
- Sarah's house (next week) 
- Ava's house (pending landlord permission)
...
- Entire park is one soil map unit (1027)
- Aim for 3 sampling points
- Avoid baseball fields and facilities due to likely underground utilities
- Stay away from dog park area
- Focus on green spaces between playground areas and trails
- Check property map to confirm park boundaries, especially near railroad easement

**Wildflower Leevee Park:**
- Small area, may only get 1-2 samples
- Parking is across railroad tracks, requires walking to site

**Simon's Ravine:**
- Multiple soil map units within park
- Sample each map unit if possible
- Larger units (e.g. 896F) can have multiple samples
- Use judgment for smaller map units - may only need one sample
- Be aware of lighted trail - may have underground utilities
- Will likely require multiple days of sampling to cover adequately

General strategy:
- Use soil map units as a starting point, but also use visual assessment on site
- Aim for representative landscape positions
- Avoid sampling unique micro-sites that wouldn't be reflected at mapping scale (1:4 acre minimum)
- Be cautious around obvious human-altered areas (e.g. graded wetlands)
